...
<div class="col-5 mx-auto pl-0 pr-0 pt-0">
		...
		<div class="col-6 pt-3 mx-auto" style="background-image: url(border.png); background-size: 100% 100%;">
			<h2 class="mt-4 mb-4 text-center" style="font-family: Geometria-Bold; font-size: 34px;">Регистрация</h2>
			<div class="text-center col-11 mx-auto mt-5 pr-2 pl-2">
				<form method="POST" action="reg_insert.php" style="font-family: TTNorms-Regular; font-size: 18px;">
					<input type="text" name="name" class="form-control border-0 pl-2 mb-0" placeholder="Имя и фамилия">
					<img src="line.png" class="w-100 mx-auto mb-5 pl-2 pr-2">
					<input type="text" name="age" class="form-control border-0 pl-2 mb-0" placeholder="Ваш возраст">
					<img src="line.png" class="w-100 mx-auto mb-5 pl-2 pr-2">
					...
					<div class="text-center mt-5 mb-1 mx-auto" style="font-family: TTNorms-Medium; font-size: 19px;">
						<input type="submit" name="submit" value="Зарегистрироваться" class="btn rounded-pill col-10 mx-auto" style="border-color: #405AFF; border-radius: 1px solid;">
					</div>
				</form>
			</div>
			<div class="text-center mt-2 pb-5 rounded" style="font-family: TTNorms-Regular; font-size: 14px;">
				<p>Есть аккаунт? <a href="auto.php" style="color: #FFC028;">Войти</a></p>
			</div>
		</div>
</div>
</body>
